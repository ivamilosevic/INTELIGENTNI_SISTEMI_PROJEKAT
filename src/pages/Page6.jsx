...
export default function Page6() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:5000/add-seat-review", {
        method: "POST",
    ...
    seat_recline: "Naslon sedišta",
    seat_width: "Širina sedišta",
    aisle_space: "Prosotr prolaza",
    viewing_tv: "Televizija"
   };
